...
#BSP:add KBSHLES-1 by kun.zhang 20180919 start
BOOT_LOGO = hdplus1520
#BSP:add KBSHLES-1 by kun.zhang 20180919 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
CUSTOM_BUILD_VERNO = CY-CB7-H623-E
...
CUSTOM_HAL_IMGSENSOR = s5k3l6_mipi_raw s5k3p9sp_mipi_raw sp250a_mipi_raw gc8034_mipi_raw
CUSTOM_TRAN_CAM_MATERIAL_CODE = s5k3l6_17201505 s5k3p9_17201531 sp250a_17201529 gc8034_17201535
CUSTOM_TRAN_HAL_MAIN3_IMGSENSOR = gc8034_mipi_raw
...
#ITD:modify by camera driver team end
#BSP: modify CBLHLES-5 by tao.lan 20181012 start
CUSTOM_HAL_MSENSORLIB =
#BSP: modify CBLHLES-5 by tao.lan 20181012 end
...
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = s5k3l6_mipi_raw s5k3p9sp_mipi_raw sp250a_mipi_raw gc8034_mipi_raw
...
#ITD:modify by camera driver team end
#BSP: modify CBQHLES-448 by tao.lan 20181102 start
CUSTOM_KERNEL_TILT_DETECTOR_SENSOR = yes
#BSP: modify CBQHLES-448 by tao.lan 20181102 end
...
#BSP: modify CBQJHLES-604 by tao.lan 20181112 start
CUSTOM_KERNEL_WAKE_GESTURE_SENSOR = yes
#BSP: modify CBQJHLES-604 by tao.lan 20181112 end
#BSP: modify CBLHLES-5 by tao.lan 20181012 end
#TSD:Modify by zhiqing.deng for modem p1 20180914 start
CUSTOM_MODEM = cb7_h623_e1
#TSD:Modify by zhiqing.deng for modem p1 20180914 end
...
#BSP: Modified XWWYLHLYS-13 by xiaolin.wu 20180928 start
#BSP: Modified XWWYLHLYS-13 by xiaolin.wu 20180928 end
MNTL_SUPPORT = no
...
#SID1: add CBLHLES-9 by shenjiang.he 18.10.11 start
MTK_BUILD_VERNO=CB7-H624H-P-190308V169
FINGERPRINT_BUILD_VERNO=H-190308V169
#SID1: add CBLHLES-9 by shenjiang.he 18.10.11 end
MTK_BWC_SUPPORT = yes
#TSD: modified by zhiqing.deng 20180929 start
MTK_C2K_LTE_MODE = 0
#TSD: modified by zhiqing.deng 20180929 end
...
#ITD modify for Close HDR by desuo.lu 2018-11-12 start
MTK_CAM_HDR_SUPPORT = no
#ITD modify for Close HDR by desuo.lu 2018-11-12 end
...
#ITD:modify by camera driver team end
#[ITD] add for thirdpart apk by desuo.lu 20181106 start
TRAN_CAMERA_THIRDPART = yes
#[ITD] add for thirdpart apk by desuo.lu 20181106 end
...
#BSP:modify CBQHLES-2 by fan.hong 2018.9.25 start
MTK_DUAL_CHARGER_SUPPORT = no
#BSP:modify CBQHLES-2 by fan.hong 2018.9.25 end
...
#TSD modify CBQHLES-305 by zhangya 2018.11.02 start
MTK_ETWS_SUPPORT = yes
#TSD modify CBQHLES-305 by zhangya 2018.11.02 end
...
# BSP : modify CBQHLES-8 by di.qian 20181010 start
MTK_FACTORY_MODE_IN_GB2312 = no
# BSP : modify CBQHLES-8 by di.qian 20181010 end
...
#TSD: modify CFQKHLYE-18 by zhaochengsheng 20180929 start
MTK_FMRADIO_APP = yes
#TSD: modify CFQKHLYE-18 by zhaochengsheng 20180929 end
...
MTK_TOUCH_BOOST = no
MTK_TTY_SUPPORT = yes
# BSP:Modify CBQHLES-1 by fangmengyao 20180920 start
MTK_UART_USB_SWITCH = yes
# BSP:Modify CBQHLES-1 by fangmengyao 20180920 end
MTK_UCE_SUPPORT = no
MTK_UFS_BOOTING = no
MTK_UFS_OTP = no
...
#TSD: modified by zhiqing.deng 20181210 start
MTK_VIWIFI_SUPPORT = yes
#TSD: modified by zhiqing.deng 20181210 end
...
#BSP: modify build version fail by wanhanfeng 20180824 start
MTK_WAPI_SUPPORT = no
#BSP: modify build version fail by wanhanfeng 20180824 end
...
#SID1: add CBLHLES-9 by shenjiang.he 18.10.11 end
#PPD: add  BFBLYB-24 by shasha.liu 20181016 start
MTK_DURASPEED_DEFAULT_ON = no
#PPD: add  BFBLYB-24 by shasha.liu 20181016 end
...
#BSP : add CBQHLES-8 by di.qian 20181016 start
TRAN_RECOVERY_NOTCH_SUPPORT = yes
#BSP : add CBQHLES-8 by di.qian 20181016 end

#BSP: add custom macro by wanghanfeng 20180830 start
CUSTOM_TRAN_PROJECT=tran_cb7
CUSTOM_TRAN_BOM=tran_cb7_e1
#BSP: add custom macro by wanghanfeng 20180830 end
#BSP:add KBSHLES-1 by kun.zhang 20180919 start
TRAN_LCM_SUPPORT = yes
#BSP:add KBSHLES-1 by kun.zhang 20180919 end
#BSP: add CBQHLES-8 by wang.qin 20181012 start
...
#BSP: add CBQHLES-8 by wang.qin 20181012 end
#BSP add XLEWHLES-16 by tao.lan 20180919 start
TRAN_FINGERPRINT_SUPPORT = sunwave_tee
#BSP add XLEWHLES-16 by tao.lan 20180919 end
...
#BSP:add KBSHLES-1 by qiang.xue 20181012 start
TRAN_TP_SUPPORT = yes
#BSP:add KBSHLES-1 by qiang.xue 20181012 end
...
#ITD:add CBQHLES-739 by yang.li3 20181120 start
TRAN_CAMERA_FLASHLIGHT_SCREEN = yes
#ITD:add CBQHLES-739 by yang.li3 20181120 end

#modify XLLSHLSSP-17 by shentao.yang for porting f2fs 20181008 start
TRAN_USE_F2FS = yes
#modify XLLSHLSSP-17 by shentao.yang for porting f2fs 20181008 end
#PPD: add  BFBLYB-24 by shasha.liu 20181016 start
...
#APP: Add KBSHLES-349 by zhaoyang.shi 20181016 start
include $(LOCAL_PATH)/ProjectConfig_APP.mk
#APP: Add KBSHLES-349 by zhaoyang.shi 20181016 end
#TSD: add CBQHLES-177 by xianzhong.zhang 20181029 start
include $(LOCAL_PATH)/ProjectConfig_TSD.mk
#TSD: add CBQHLES-177 by xianzhong.zhang 20181029 end
#[ITD]add cam 3pty function XWWYLHLYS-302 by xiaoxue.cai 20181031 start
TRAN_CAMERA_FEATURE = yes
#[ITD]add cam 3pty function XWWYLHLYS-302 by xiaoxue.cai 20181031 end
#TDD:add CBQHLES-106 by jingang.yi 2018.11.12 start
include $(LOCAL_PATH)/ProjectConfig_CDD.mk
#TDD:add CBQHLES-106 by jingang.yi 2018.11.12 end

#ITD:modify RABHLYSP-11 by quan.chang 181127 start
CUSTOM_TRAN_PCBA = tran_pcba_h624
